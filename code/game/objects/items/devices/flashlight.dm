...
/obj/item/flashlight/proc/inspect_vision(obj/item/organ/vision, mob/living/user)
	...
	if(!BP_IS_PROSTHETIC(vision))
		...
		var/list/pinpoint = list(/decl/material/liquid/tramadol=5,/decl/material/liquid/hyperzine=1)
		var/list/dilating = list(/decl/material/liquid/psychoactives=5,/decl/material/liquid/mindbreaker_toxin=1,/decl/material/liquid/adrenaline=1)
