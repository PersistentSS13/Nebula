...
#define MAP_TEMPLATE_CATEGORY_LANDMARK_LOADED "landmark_template"///PS13 Template that is spawned as part of the main map, and shouldn't be considered an away site during unit tests.
