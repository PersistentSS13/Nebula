...
#define ZLEVEL_PERSISTENT BITFLAG(5) //If set the z-level will be added to the saved level list
#define ZLEVEL_MINING     BITFLAG(6) //If set the z-level will be regenerated by the mining regen subsystem
