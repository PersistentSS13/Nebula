/obj/item/chargen_box/science/emt
	name = "emt kit"
	startswith = list(
...
/obj/item/chargen_box/science/doctor
	name = "doctor's kit"
	startswith = list(
		/obj/item/clothing/accessory/armband/med = 1,
		/obj/item/storage/firstaid/regular = 1,
		/obj/item/clothing/accessory/stethoscope = 1,
		/obj/item/flashlight/pen = 1,
		/obj/item/scanner/health = 1
	)

/obj/item/chargen_box/science/surgery
	name = "surgery kit"
	startswith = list(
...
/obj/item/chargen_box/science/rnd
	name = "science starter kit"
	startswith = list(
