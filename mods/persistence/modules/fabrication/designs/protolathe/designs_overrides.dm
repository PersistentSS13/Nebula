// a set of bogus designs to disallow them from being researchable - primarily used for legacy guns, as there's no way to cleanly disallow existing recipes as of now

/datum/fabricator_recipe/protolathe/weapon/rapidsyringe
	required_technology = @"{'coding':999}"
