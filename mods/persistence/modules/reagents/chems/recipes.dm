...
/datum/chemical_reaction/dexalinplus
	...
	required_reagents = list(/decl/material/liquid/oxy_meds, /decl/material/solid/metal/iron = 1, /decl/material/solid/metal/tin = 1)
...
/datum/chemical_reaction/oxycodone
	...
	required_reagents = list(/decl/material/liquid/painkillers = 1, /decl/material/solid/sodium = 1, /decl/material/solid/metal/zinc = 1)
