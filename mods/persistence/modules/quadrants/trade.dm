var/global/list/all_trade_beacons = list()
...
/atom/proc/get_adjacent_trade_beacons()
	...
	if(ob)
		...
		if(T)
			for(var/obj/beacon in all_trade_beacons)
...
/datum/computer_file/program/trade_management/on_shutdown()
	. = ..()
	current_map_z = null
