...
/**
 * Helper proc to return the saved variables datum for a given path.
*/
...
/**
 * Helper proc to return a list of saved vars for a given type of datum/atom.
*/
...
/decl/saved_variables/datum
	type_path = /datum
	base_type = null //There's no base type that's not in the path to datum
...
/datum/dna/after_deserialize()
	. = ..()
	if(!LAZYLEN(SE))
		log_debug("[src] SE is null after_deserialize()!")
...
/datum/dna/after_deserialize()
	. = ..()
	to_world_log("DNA: Was deserialized as: real_name:[real_name], species:[species], b_type:[b_type]. SE: {[log_info_line(SE)]}")

/datum/dna/New()
	. = ..()
	if(persistent_id)
		to_world_log("AFTER INIT DNA: real_name:[real_name], species:[species], b_type:[b_type]. SE: {[log_info_line(SE)]}")
...
SAVED_VAR(/datum/mind, known_connections)
...
SAVED_VAR(/datum/computer_file/report, access_edit)
SAVED_VAR(/datum/computer_file/report, access)
...
SAVED_VAR(/mob/living/bot, target_patience)
...
SAVED_VAR(/mob/living/silicon/robot, jeton)
...
SAVED_VAR(/mob/living/silicon/pai, network)
SAVED_VAR(/mob/living/silicon/pai, ram)
SAVED_VAR(/mob/living/silicon/pai, software)
SAVED_VAR(/mob/living/silicon/pai, userDNA)
...
SAVED_VAR(/mob/living/silicon/pai, screen)
SAVED_VAR(/mob/living/silicon/pai, subscreen)
...
SAVED_VAR(/obj/item/assembly/signaler, delay)
SAVED_VAR(/obj/item/assembly/signaler, airlock_wire)
...
SAVED_VAR(/obj/item/robot_parts, part)
...
SAVED_VAR(/obj/item/card/id, associated_email_login)
...
SAVED_VAR(/obj/item/card/id, dorm)
...
SAVED_VAR(/obj/item/paper, stamps)
SAVED_VAR(/obj/item/paper, stamped)
SAVED_VAR(/obj/item/paper, ico)

SAVED_VAR(/obj/item/paper_bundle, page)
...
SAVED_VAR(/obj/machinery/door/airlock, lockdownbyai)
...
SAVED_VAR(/obj/machinery/door/firedoor, net_id)
...
SAVED_VAR(/obj/machinery/papershredder, paperamount)
SAVED_VAR(/obj/machinery/papershredder, shred_amounts)

SAVED_VAR(/obj/machinery/photocopier/faxmachine, department)

SAVED_VAR(/obj/machinery/photocopier, copyitem)
SAVED_VAR(/obj/machinery/photocopier, copies)
SAVED_VAR(/obj/machinery/photocopier, toner)
...
SAVED_VAR(/obj/machinery/portable_atmospherics/hydroponics, health)
...
SAVED_VAR(/obj/machinery/power/emitter, active)
SAVED_VAR(/obj/machinery/power/emitter, locked)
SAVED_VAR(/obj/machinery/power/emitter, powered)
SAVED_VAR(/obj/machinery/power/emitter, burst_shots)
SAVED_VAR(/obj/machinery/power/emitter, shot_number)

SAVED_VAR(/obj/machinery/power/port_gen, active)
SAVED_VAR(/obj/machinery/power/port_gen, power_output)
...
SAVED_VAR(/obj/machinery/power/solar, health)
...
SAVED_VAR(/obj/item/ducttape, stuck)
...
SAVED_VAR(/obj/machinery/power/port_gen/pacman, sheets)
SAVED_VAR(/obj/machinery/power/port_gen/pacman, operating_temperature)
SAVED_VAR(/obj/machinery/power/port_gen/pacman, overheating)

SAVED_VAR(/obj/machinery/power/solar_control, cdir)
SAVED_VAR(/obj/machinery/power/solar_control, gen)
SAVED_VAR(/obj/machinery/power/solar_control, lastgen)
SAVED_VAR(/obj/machinery/power/solar_control, connected_tracker)
SAVED_VAR(/obj/machinery/power/solar_control, connected_panels)
...
SAVED_VAR(/obj/machinery/telecomms/server, TrafficActions)
SAVED_VAR(/obj/machinery/telecomms/server, logs)
SAVED_VAR(/obj/machinery/telecomms/server, memory)
...
SAVED_VAR(/obj/machinery/power/fusion_core, owned_field)
SAVED_VAR(/obj/machinery/power/fusion_core, field_strength)
...
SAVED_VAR(/obj/machinery/compressor, inturf)
SAVED_VAR(/obj/machinery/compressor, starter)
SAVED_VAR(/obj/machinery/compressor, rpm)
SAVED_VAR(/obj/machinery/compressor, rpmtarget)
SAVED_VAR(/obj/machinery/compressor, capacity)
SAVED_VAR(/obj/machinery/compressor, comp_id)

SAVED_VAR(/obj/machinery/power/turbine, outturf)
SAVED_VAR(/obj/machinery/power/turbine, lastgen)
...
SAVED_VAR(/obj/machinery/power/emitter/gyrotron, rate)
SAVED_VAR(/obj/machinery/power/emitter/gyrotron, mega_energy)
...
SAVED_VAR(/obj/item/electronic_assembly, can_charge)
SAVED_VAR(/obj/item/electronic_assembly, charge_sections)
SAVED_VAR(/obj/item/electronic_assembly, charge_delay)
...
SAVED_VAR(/obj/item/electronic_assembly, next_assembly_id)
...
SAVED_VAR(/obj/item/integrated_electronics/detailer, data_to_write)
SAVED_VAR(/obj/item/integrated_electronics/detailer, accepting_refs)
...
SAVED_VAR(/obj/item/integrated_circuit/passive/power/chemical_cell, lfwb)
...
SAVED_VAR(/obj/item/integrated_circuit/converter/refdecode, dec)
...
SAVED_VAR(/obj/machinery/power/rad_collector, health)
SAVED_VAR(/obj/machinery/power/rad_collector, melted)
SAVED_VAR(/obj/machinery/power/rad_collector, active)
SAVED_VAR(/obj/machinery/power/rad_collector, locked)
SAVED_VAR(/obj/machinery/power/rad_collector, last_rads)
SAVED_VAR(/obj/machinery/power/rad_collector, loaded_tank)
...
SAVED_VAR(/obj/structure/bigDelivery, wrapped)
SAVED_VAR(/obj/structure/bigDelivery, sortTag)
SAVED_VAR(/obj/structure/bigDelivery, examtext)
SAVED_VAR(/obj/structure/bigDelivery, nameset)
SAVED_VAR(/obj/structure/bigDelivery, label_y)
SAVED_VAR(/obj/structure/bigDelivery, label_x)
SAVED_VAR(/obj/structure/bigDelivery, tag_x)
...
SAVED_VAR(/obj/structure/dispenser, oxygentanks)
SAVED_VAR(/obj/structure/dispenser, hydrogentanks)
