...
SAVED_VAR(/mob/living/carbon/human, _wear_suit)
SAVED_VAR(/mob/living/carbon/human, _w_uniform)
SAVED_VAR(/mob/living/carbon/human, _shoes)
SAVED_VAR(/mob/living/carbon/human, _belt)
SAVED_VAR(/mob/living/carbon/human, _gloves)
SAVED_VAR(/mob/living/carbon/human, _glasses)
SAVED_VAR(/mob/living/carbon/human, _head)
SAVED_VAR(/mob/living/carbon/human, _l_ear)
SAVED_VAR(/mob/living/carbon/human, _r_ear)
SAVED_VAR(/mob/living/carbon/human, _wear_id)
SAVED_VAR(/mob/living/carbon/human, _r_store)
SAVED_VAR(/mob/living/carbon/human, _l_store)
SAVED_VAR(/mob/living/carbon/human, _s_store)
...
SAVED_VAR(/mob/living/carbon/human, wearing_rig)
