/mob/living/carbon/death()
	...
	to_world_log("death called?")
	if(ckey && client)
		to_world_log("player died")
		var/obj/item/organ/internal/stack/stack = switchToStack(mind, ckey)
		if(stack)
			to_world_log("stack found")
